...
def home(request):
    chapters = Chapter.objects.prefetch_related('lessons__flashcards', 'lessons__quizzes')
    return render(request, 'apps/home.html', {'chapters': chapters})
...
def register_user(request):
    if request.method == 'POST':
        ...
        # Optional: basic check if user exists
...
def chapter_detail(request, chapter_id):
    ...
    return render(request, 'apps/chapter_detail.html', {
        'chapter': chapter,
        'lessons': lessons
    })
...
def lesson_detail(request, lesson_id):
    ...
    return render(request, 'apps/lesson_detail.html', {
        'lesson': lesson,
        'flashcards': flashcards,
        'quizzes': quizzes,
        'results': results,  # Full results for all quizzes
        'score': score,      # Total score across all quizzes
    })
